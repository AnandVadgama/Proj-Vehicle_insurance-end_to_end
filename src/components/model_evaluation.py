    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            if best_model is not None:
                ...
                except Exception as prod_model_error:
                    logging.warning(f"Could not evaluate production model (may have incompatible schema): {prod_model_error}")
                    logging.info("Treating production model as unavailable - new model will be accepted")
                    best_model_f1_score = None
